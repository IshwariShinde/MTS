  ...
  return (
    <div className='customsoftware'>
        ...
        <div className='custom_dev_test_deploy' >
          ...
          <div className='custom_dev_test_deploy_inner'>
          <h1>Testing</h1>
            <p>We take care of every sprint/milestone, from manual to automated testing processes. It is important to write user stories in a very detailed and task-oriented manner, so that the information gathered can be used efficiently. With the goal in mind, our testing includes Unit, Manual, Regression, Security, and Google webmaster testing, the result a bug-free and approved application that delights users and makes management better. </p>
          </div>
          <div className='custom_dev_test_deploy_inner'>
          <h1>Deployment</h1>
            <p>The final task is to deploy our software. Although it may seem complicated, we have a checklist of best practices to ensure that we don't miss anything important. Our developers are experts in the right deployment tools and integration servers, and they know which KPIs are important to monitor during the live testing phase. Plus, we have a rollback strategy in place so that we can reverse any mistakes that are made.</p>
          </div>
        </div>
